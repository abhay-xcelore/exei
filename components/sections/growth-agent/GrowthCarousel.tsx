...
const capabilities: CapabilityCard[] = [
  {
    id: 1,
    iconSrc: "/icons/growth-agent/broadcasts.svg",
    title: "Proactive Campaign Broadcasts",
    description:
      "Announce new collection drops, seasonal events, and holiday sales directly to high-intent buyer segments on WhatsApp and Voice.",
  },
  {
    id: 2,
    iconSrc: "/icons/growth-agent/flows.svg",
    title: "Automated Win-Back Flows",
    description:
      "Automatically re-engage shoppers who haven't ordered in 30, 60, or 90 days with personalized offers tailored to their last purchase behavior.",
  },
  {
    id: 3,
    iconSrc: "/icons/growth-agent/nudges.svg",
    title: "Smart Loyalty Nudges",
    description:
      'Send timely reminders before earned points expire, deliver VIP redemption perks, and trigger automated "Bought A → Recommend B" post-purchase sequences.',
  },
  {
    id: 4,
    iconSrc: "/icons/growth-agent/offers.svg",
    title: "Tailored Re-Engagement Offers",
    description:
      "Bring back inactive buyers with context-aware offers and relevant product recommendations while preserving full-price value for active shoppers.",
  },
  {
    id: 5,
    iconSrc: "/icons/growth-agent/outreach.svg",
    title: "Omnichannel Retention Outreach",
    description:
      "Launch brand-initiated broadcast campaigns and automated event workflows natively across WhatsApp, Voice lines, and Voice APIs.",
  },
];
...
export default function CapabilitiesCarousel() {
  ...
  // Auto-slide every 3 seconds (pauses on user hover/touch)
  useEffect(() => {
    if (isHovered) return;
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-6 sm:mb-8">
            <div className="max-w-2xl">
              <h2 className="text-2xl sm:text-3xl md:text-[36px] font-medium tracking-tight text-white leading-tight mb-3">
                Deploy Next-Gen AI Growth Agent <br className="hidden sm:inline" />
                That Work Before You Ask
              </h2>
              <p className="text-sm sm:text-base text-gray-100 font-[300] m-0">
                Brand-initiated outreach made easy with Growth agent. Reach your customers proactively with campaigns, win-backs, and loyalty messaging.
              </p>
            </div>
