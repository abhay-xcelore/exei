...
// Helper for loading custom image icons dynamically
function CustomIcon({
  src,
  alt,
  size = 20,
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs sm:text-sm text-gray-200 font-medium">
          ...
          <div className="flex items-center gap-2">
            <CustomIcon
              src="/icons/whatsapp-automation/meta23.png"
          ...
          {/* Tag 2: Language / Multilingual Icon */}
          <div className="flex items-center gap-2">
            <CustomIcon
              src="/icons/whatsapp-automation/languages.svg"
              alt="80+ Languages Supported"
              size={30}
            />
            <span>80+ language Supported</span>
          </div>

          {/* Tag 3: Shopify / Integration Icon */}
          <div className="flex items-center gap-2">
            <CustomIcon
              src="/icons/whatsapp-automation/shopifyL.svg"
              alt="Shopify & CRM Ready"
              size={24}
            />
