...
export default function ScaleOperationsHero() {
  return (
    <section className="relative w-full bg-black text-white font-[var(--font-poppins)] overflow-hidden rounded-[2rem] pt-24 sm:pt-26 md:pt-32 pb-20 sm:pb-28 md:pb-36 px-6 md:px-12 lg:px-16">
