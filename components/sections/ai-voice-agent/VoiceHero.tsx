    ...
    <section className="w-full bg-white text-gray-900 pt-20 sm:pt-28 lg:pt-36 pb-0 px-4 sm:px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <motion.h1
          ...
          className="text-2xl sm:text-3xl md:text-4xl lg:text-[56px] font-extrabold tracking-tight text-gray-900 max-w-4xl leading-[1.1] mb-3 sm:mb-4"
        >
          AI Voice Agent for Optimal <br className="hidden sm:inline" />
        ...
        <motion.p
          ...
          className="text-gray-500 text-xs sm:text-base md:text-lg max-w-2xl font-normal leading-relaxed mb-3 sm:mb-4"
        >
          Handle inbound support and run automated phone campaigns using human-like voice agents that speak native Indian languages.
        </motion.p>
