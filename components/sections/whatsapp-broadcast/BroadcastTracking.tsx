...
const capabilities: CapabilityCard[] = [
  {
    ...
    title: "Conversational Shopping Assistance",
    description:
      "When shoppers reply to your broadcast message for whatsapp, the AI answers questions, shares fit guidance, and curates products in real time.",
  },
  {
    id: 2,
    mediaSrc: "/images/capabilities/live-sync.png",
    title: "Instant Checkout & Upsells",
    description:
  ...
  },
  {
    ...
    title: "Automated Analytics & Store Sync",
    description:
      "Automatically record campaign performance, buyer responses, and customer tags across your Shopify store and CRM.",
  },
];
          ...
          <div className="flex flex-col md:flex-row lg:flex-col items-start md:items-end lg:items-center justify-between lg:justify-center text-left lg:text-center gap-6 mb-8 sm:mb-10">
            <div className="max-w-3xl">
              <h2 className="text-2xl sm:text-3xl md:text-[36px] font-medium tracking-tight text-white leading-tight mb-3">
                Real-Time In-Chat Conversion & Tracking
              </h2>
              <p className="text-sm sm:text-base text-gray-100 font-[300] m-0">
                Convert campaign interest into revenue with instant conversational replies.
              </p>
            </div>
