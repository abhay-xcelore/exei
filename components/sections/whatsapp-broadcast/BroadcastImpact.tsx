...
const benefits = [
  {
    id: "collection-drops-sale-alerts",
    label: "Collection Drops & Sale Alerts",
    icon: "/icons/growth-agent/multilingual.svg",
    title: "Instant Support in 80+ Languages",
    description:
      "Create a targeted broadcast message for whatsapp to announce seasonal promotions, restock drops, and exclusive discounts.",
  },
  {
    id: "lapsed-customer-win-backs",
    label: "Lapsed Customer Win-Backs",
    icon: "/icons/growth-agent/deployments.svg",
    title: "Lapsed Customer Win-Backs",
    description:
      "Launch a segmented campaign to bring back inactive buyers based on what they previously purchased.",
  },
  {
    id: "automated-event-driven-alerts",
    label: "Automated Event-Driven Alerts",
    icon: "/icons/growth-agent/context.svg",
    title: "Automated Event-Driven Alerts",
    description:
      "Share order confirmations, delivery status notifications, and reorder reminders at key moments in the customer journey.",
  },
  {
    id: "safe-verified-delivery",
    label: "Safe & Verified Delivery",
    icon: "/icons/growth-agent/messaging.svg",
    title: "Safe & Verified Delivery",
    description:
      "Send every message through official Meta Business channels to protect your brand from blocks and spam flags.",
  },
];
          ...
          <div className="col-span-6">
            <div className="sticky top-28">
              <h2 className="text-2xl sm:text-3xl md:text-[36px] font-semibold text-gray-900 tracking-tight leading-tight mb-4">
                High - Impact Targeted WhatsApp Broadcast Message
              </h2>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6">
                Send proactive, relevant updates that keep your brand top-of-mind and drive repeat purchases.
              </p>
