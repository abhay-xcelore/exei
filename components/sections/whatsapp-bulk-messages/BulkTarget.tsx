...
const benefits = [
  {
    id: "new-drops-festive-promotions",
    label: "New Drops & Festive Promotions",
    icon: "/icons/growth-agent/multilingual.svg",
    title: "New Drops & Festive Promotions",
    description:
      "Deliver a tailored bulk whatsapp message for new collection launches, flash sales, and festival discounts to high-intent shoppers.",
  },
  {
    id: "win-back-inactive-customers",
    label: "Win-Back Inactive Customers",
    icon: "/icons/growth-agent/deployments.svg",
    title: "Win-Back Inactive Customers",
    description:
      "Use bulk whatsapp messaging to re-engage buyers who haven't purchased in 30, 60, or 90 days with personalized offers.",
  },
  {
    id: "loyalty-vip-perks",
    label: "Loyalty & VIP Perks",
    icon: "/icons/growth-agent/context.svg",
    title: "Loyalty & VIP Perks",
    description:
      "Send reward points expiry notices, early-access collection links, and replenishment reminders directly to customer phones.",
  },
  {
    id: "policy-compliant-infrastructure",
    label: "100% Policy-Compliant Infrastructure",
    icon: "/icons/growth-agent/messaging.svg",
    title: "100% Policy-Compliant Infrastructure",
    description:
      "Deliver every campaign through verified Meta APIs to ensure high inbox placement without risking number restrictions.",
  },
];
          ...
          <div className="col-span-6">
            <div className="sticky top-28">
              <h2 className="text-2xl sm:text-3xl md:text-[36px] font-semibold text-gray-900 tracking-tight leading-tight mb-4">
                Targeted Campaigns with WhatsApp Bulk Messaging
              </h2>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6">
                Reach the right audience segments at the perfect time with brand-initiated outreach.
              </p>
