...
const steps: Step[] = [
  {
    id: 0,
    iconSrc: "/icons/shopping-assistant/message.svg",
    title: "Engage",
    description:
      "Captures visitor attention across web and social with timely, contextual prompts.",
  },
  {
    id: 1,
    iconSrc: "/icons/shopping-assistant/personalize.svg",
    title: "Personalize",
    description:
      "Learns customer preferences through natural 1:1 conversation & past purchase history.",
  },
  {
    id: 2,
    iconSrc: "/icons/shopping-assistant/recommended.svg",
    title: "Recommend",
    description:
      "Curates exact-match options from your live catalog using rich visual cards.",
  },
  {
    id: 3,
    iconSrc: "/icons/shopping-assistant/convert.svg",
    title: "Convert",
    description:
      "Guides the customer through frictionless add-to-cart CTAs directly in the chat.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-10">
          <h2 className="text-2xl sm:text-3xl md:text-[36px] font-medium text-gray-900 tracking-tight leading-tight mb-4">
            Inside The AI Shopping Assistant Revenue Engine
          </h2>
          <p className="text-gray-700 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            How Exei AI powered shopping assistant transforms standard store traffic into loyal, repeat customers.
          </p>
        </div>
